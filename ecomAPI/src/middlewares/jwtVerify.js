...
// Kiểm tra đảm bảo rằng chỉ người dùng được xác thực mới có thể truy cập vào hoặc thực hiện các hành động nhất định
const middlewareControllers = {
  // kiểm tra tính hợp lệ của token được gửi trong Authorization
