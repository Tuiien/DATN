              ...
              <ul className="list">
                <li>
                  <a href="#">
                    ...
                    <i className="fa fa-star" />
                    <i className="fa fa-star" />
                    <i className="fa fa-star" /> Có{" "}
                    {inputValues.countStar.star5} lượt đánh giá
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <i className="fa fa-star" />
                    <i className="fa fa-star" /> Có{" "}
                    {inputValues.countStar.star4} lượt đánh giá
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <i className="fa fa-star" />
                    <i className="fa fa-star" /> Có{" "}
                    {inputValues.countStar.star3} lượt đánh giá
                  </a>
                </li>
                <li>
                  <a href="#">
                    ...
                    <i className="fa fa-star" />
                    <i className="fa fa-star" /> Có{" "}
                    {inputValues.countStar.star2} lượt đánh giá
                  </a>
                </li>
                <li>
                  <a href="#">
                    1
                    <i className="fa fa-star" /> Có{" "}
                    {inputValues.countStar.star1} lượt đánh giá
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="review_list">
          ...
          {inputValues.dataReview &&
            ...
            inputValues.dataReview.map((item, index) => {
              if (!item.parentId) {
                let name = `${item.user.firstName ? item.user.firstName : ""} ${
                  item.user.lastName
                }`;
                let arrStar = [];
