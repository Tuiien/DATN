  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      socketRef.current.on("getId", (data) => {
        setId(data);
      }); // phần này để gán id cho mỗi phiên kết nối vào page. Mục đích chính là để phân biệt đoạn nào là của mình đang chat.
      ...
      <div className="main_menu">
        <div className="container">
          <nav className="navbar navbar-expand-lg navbar-light w-100">
            ...
            {/* Thu thập nav links, forms và nội dung khác để chuyển đổi */}
            <div
